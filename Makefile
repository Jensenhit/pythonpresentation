...
test:
	...
	qt5.pkg.macos-$(MACOS_VERSION)-release/sunano.app/Contents/MacOS/sunano -b -r test-pylib-script.py; \
	cd qt5.build.macos-$(MACOS_VERSION)-release; \
	ln -s sunano.app/Contents/MacOS/sunano sunano; \
...
dropbox-deploy:
	...
	hdiutil convert macbuild/Resources/sunanoDMGTemplate.dmg -format UDRW -o work-KLayout.dmg; \
