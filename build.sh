...
if ! [ -e src ] || ! [ -e src/sunano.pro ]; then
...
echo "Version Info:"
echo "    Version: $sunano_VERSION"
echo "    Date: $sunano_VERSION_DATE"
echo "    Revision: $sunano_VERSION_REV"
echo ""
...
echo $QMAKE "$CURR_DIR/src/sunano.pro" "${qmake_options[@]}"
$QMAKE "$CURR_DIR/src/sunano.pro" "${qmake_options[@]}"
