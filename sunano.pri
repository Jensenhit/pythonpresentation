...
VERSION_STRING = $$sunano_VERSION
VERSION_STRING_WITH_BLANKS = $$replace(VERSION_STRING, "\\.", " ")
eval(VERSION_ARRAY = $$VERSION_STRING_WITH_BLANKS)

sunano_MAJOR_VERSION = $$member(VERSION_ARRAY, 0)

sunano_MINOR_VERSION = $$member(VERSION_ARRAY, 1)

sunano_TINY_VERSION = $$member(VERSION_ARRAY, 2)
isEmpty(sunano_TINY_VERSION) {
  sunano_TINY_VERSION = 0
}
...
DEFINES += \
  ...
  sunano_MAJOR_VERSION=$$sunano_MAJOR_VERSION \
  sunano_MINOR_VERSION=$$sunano_MINOR_VERSION \
  sunano_TINY_VERSION=$$sunano_TINY_VERSION \

VERSION = $$sunano_VERSION
